# Add this function after the _embed_query function and before _retrieve_context
...
# Now modify your query_expense_gpt function - replace the existing function with this:
...
def query_expense_gpt(question: str, top_k: int = 10):
    try:
        ...
        # EXISTING CODE CONTINUES (don't change anything below this)
